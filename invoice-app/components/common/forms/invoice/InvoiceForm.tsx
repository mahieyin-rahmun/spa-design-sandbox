          ...
          <Form>
            ...
            <Box my={2} py={2}>
              ...
              <Grid container spacing={4}>
                ...
                <Grid item xs={12}>
                  <InputField name="to.streetAddress" label="Street Address" />
                </Grid>
                <Grid item xs={6} md={4}>
                ...
                <Grid item xs={12} sm={6}>
                  <SelectField
                    ...
                    selectOptions={[
                      {
                        label: "Net 30 days",
                        value: TInvoiceFormInputTypes.EPaymentTerms.NET_30_DAYS,
                      },
                      {
                        label: "Net 1 year",
                        value: TInvoiceFormInputTypes.EPaymentTerms.NET_1_YEAR,
                      },
                      {
                        label: "Net 6 months",
                        value:
                      ...
                      ({ quantity, unitPrice }, index: number) => (
                        <React.Fragment key={index}>
                          <Grid item xs={12} sm={4}>
                            ...
                            <InputField name={`items.${index}.name`} label="" />
                          </Grid>
                          <Grid item xs={3} sm={2}>
                            {isMobileScreen && (
                              <Typography color="textSecondary">
